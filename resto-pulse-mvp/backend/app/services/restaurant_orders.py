...
def create_restaurant_order(
    ...
    *,
    ...
    user: User,
    customer_phone: str,
    delivery_street_node_id: int,
    delivery_door_number: str,
    ...
    try:
        clean_address, delivery_lat, delivery_lng = resolve_delivery_address(
            db,
            street_node_id=delivery_street_node_id,
            door_number=delivery_door_number,
    ...
    order = RestaurantOrder(
        ...
        delivery_building_node_id=delivery_street_node_id,
        delivery_door_number=delivery_door_number.strip(),
