...
async def submit_business_application(
    ...
    kvkk_consent: bool = Form(default=False),
    contract_accepted: bool = Form(default=False),
    contract_postal_promised: bool = Form(default=False),
    tax_document: UploadFile | None = File(default=None),
