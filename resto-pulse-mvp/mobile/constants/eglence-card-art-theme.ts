...
const GAME_ART: Record<EglenceGameId, GameArtConfig> = {
  ...
  'kelime-bul': {
    carousel: {
      ...
      overlay: 'rgba(40, 18, 6, 0.12)',
      scrim: 'rgba(28, 14, 6, 0.42)',
      bg: '#1A1008',
    },
    lobby: {
      bg: '#1A1008',
      ...
      panel: 'rgba(28, 18, 10, 0.92)',
      border: 'rgba(255, 171, 96, 0.28)',
      borderStrong: 'rgba(255, 179, 71, 0.52)',
      artOpacity: 1,
      artScale: 1.08,
      sceneOverlay: 'rgba(28, 14, 6, 0.4)',
      sceneBottomScrim: 'rgba(20, 10, 4, 0.5)',
    },
  },
};
